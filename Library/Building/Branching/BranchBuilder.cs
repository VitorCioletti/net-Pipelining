namespace PipeliningLibrary
{
    ...
    public class BranchBuilder
    {
        ...
        /// Sets that this pipeline can branch to specified pipeline.
        /// </summary>
        /// <param name="id">Enum of the pipeline ID that it can branch to</param>
        /// <returns>This builder instance, so you can use it in a fluent fashion</returns>
        public BranchBuilder BranchTo(Enum id) => 
            BranchTo(id.ToString());

        /// <summary>
        /// Sets that this pipeline can branch to specified pipeline.
        /// </summary>
        /// <param name="id">Enum of the pipeline ID that has been constructed by this call</param>
